...
import org.summerframework.beans.factory.LifecycleBean;
...
import org.summerframework.web.context.support.XmlWebApplicationContext;
import org.summerframework.web.mock.MockServletContext;
import org.summerframework.web.mock.MockServletConfig;
...
public class ContextLoaderTestSuite extends TestCase {
    ...
    public void testContextLoaderListenerWithDefaultContext() throws Exception {
        MockServletContext sc = new MockServletContext("", "/org/summerframework/web/context/WEB-INF/web.xml");
        sc.addInitParameter(XmlWebApplicationContext.CONFIG_LOCATION_PARAM, "/org/summerframework/web/context/WEB-INF/applicationContext.xml");
    ...
    public void testClassPathXmlApplicationContext() throws IOException {
        ApplicationContext context = new ClassPathXmlApplicationContext("/org/summerframework/web/context/WEB-INF/applicationContext.xml");
        ...
        context = new ClassPathXmlApplicationContext(new String[]{"/org/summerframework/web/context/WEB-INF/applicationContext.xml",
                "/org/summerframework/web/context/WEB-INF/test-servlet.xml"});
        assertTrue("Has father", context.getBean("father") != null);
        assertTrue("Has father", context.getBean("rod") != null);
